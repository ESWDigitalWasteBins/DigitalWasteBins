...
class Stopwatch:
    ...
    def __init__(self, running_now=False, running_forward=True, elapsed_prior=0, last_start_time=0):
        ...
        self._last_start_time = (
            time.clock() if running_now else last_start_time)

    def reset(self, running_now=False, running_forward=True, elapsed_prior=0, last_start_time=0):
        """
    ...
    def _update(self):
        ...
        """
        self._elapsed_prior += (1 if self._running_forward else -1) * \
            (time.clock() - self._last_start_time)
        self._last_start_time = time.clock()
